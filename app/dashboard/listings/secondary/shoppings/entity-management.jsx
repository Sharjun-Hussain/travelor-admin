...
export const EntityManagement = ({
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-full">
      ...
      {/* Add Craft Bazaar Dialog */}
      {addEntity && (
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="text-xl">
                Add New Craft Bazaar
              </DialogTitle>
              <DialogDescription>
                Create a new craft bazaar for your platform
              </DialogDescription>
            </DialogHeader>
            {createForm ? (
              ...
              <form onSubmit={handleAddEntity}>
                ...
                <DialogFooter className="mt-6">
                  ...
                  >
                    {addMutation.isPending ? "Adding..." : "Add Craft Bazaar"}
                  </Button>
                </DialogFooter>
              </form>
            )}
      ...
      {/* Edit Craft Bazaar Dialog */}
      {updateEntity && (
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="text-xl">Edit Craft Bazaar</DialogTitle>
              <DialogDescription>
                Update craft bazaar information
              </DialogDescription>
            </DialogHeader>
            {editForm ? (
      ...
      {/* View Craft Bazaar Dialog */}
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="sm:max-w-4xl">
          <DialogHeader>
            <DialogTitle className="text-xl">Craft Bazaar Details</DialogTitle>
          </DialogHeader>
          {currentEntity && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Left Column - Bazaar Identity */}
              <div className="flex flex-col items-center p-4 border rounded-lg border-slate-200 bg-slate-50">
                ...
                <p className="text-slate-500 mb-4">{currentEntity.category}</p>
              ...
              <div className="space-y-4">
                <div className="p-4 border rounded-lg border-slate-200">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {currentEntity.productTypes?.map((type, index) => (
                      <Badge
                        key={index}
                        variant="outline"
                    ...
                    <div className="bg-slate-50 p-3 rounded-md">
                      <div className="flex items-center mb-1">
                        ...
                        <span className="text-xs text-slate-500">
                          Reviewed by:{" "}
                          {currentEntity.slvistaReviews[0].reviewedBy}
                        </span>
                      </div>
              ...
              <div className="flex items-center p-4 mb-4 bg-red-50 text-red-800 rounded-md">
                ...
                <div>
                  <p className="font-medium">
                    Are you sure you want to delete this craft bazaar?
                  </p>
