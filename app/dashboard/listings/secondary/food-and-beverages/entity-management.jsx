    ...
    <div className="container mx-auto py-8 px-4 max-w-full">
                ...
                >
                  ...
                  {enableExport && (
                    <Button
                      variant="outline"
                      className="border-slate-300"
                      onClick={() => exportToExcel(entities, "Shopping Datas")}
                    >
      ...
      {addEntity && (
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="text-xl">Add New {entityName}</DialogTitle>
              <DialogDescription>
                Create a new {entityName} for your platform
              </DialogDescription>
            </DialogHeader>
            <form onSubmit={handleAddEntity}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
                ...
                <div className="space-y-4">
                  ...
                  {/* <div className="grid gap-2">
                    ...
                    <Input
                      id="type"
                      name="type"
                      placeholder={`Enter ${entityName} type`}
                      value={formData.type}
                      onChange={handleInputChange}
                      required
                      className="border-slate-300"
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="cuisineType" className="text-slate-700">
                      Cuisine Type
                    </Label>
                    <Input
                      id="cuisineType"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="dietaryOptions" className="text-slate-700">
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      checked={formData.acceptsReservation}
                      onCheckedChange={(checked) =>
                        setFormData({
                          ...formData,
                          acceptsReservation: checked,
                        })
                      }
                    />
                    <Label htmlFor="acceptsReservation" className="text-slate-700">
              ...
              <DialogFooter className="mt-6">
                ...
                >
                  {addMutation.isPending ? "Adding..." : `Add ${entityName}`}
                </Button>
              </DialogFooter>
            </form>
          </DialogContent>
      ...
      {updateEntity && (
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="text-xl">Edit {entityName}</DialogTitle>
              <DialogDescription>
                Update {entityName} information
              </DialogDescription>
            </DialogHeader>
      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="sm:max-w-4xl">
          <DialogHeader>
            <DialogTitle className="text-xl">{entityName} Details</DialogTitle>
          </DialogHeader>
          {currentEntity && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col items-center p-4 border rounded-lg border-slate-200 bg-slate-50">
                ...
                <p className="text-slate-500 mb-2">{currentEntity.type}</p>
                {currentEntity.cuisineType && (
                  <p className="text-slate-500 mb-4">
                    Cuisine: {currentEntity.cuisineType}
                  </p>
                )}
                ...
                <div className="w-full mt-2">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-slate-600">
                        {currentEntity.location?.address && (
                          <>{currentEntity.location.address}, </>
                        )}
                  ...
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div>
                      {renderStatusBadge(currentEntity.status)}
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-slate-600">
                      {currentEntity.acceptsReservation ? "Yes" : "No"}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="p-4 border rounded-lg border-slate-200">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {currentEntity.dietaryOptions?.length > 0 ? (
                      currentEntity.dietaryOptions.map((option, index) => (
                        <Badge
                          key={index}
                          variant="outline"
                      ...
                      <p className="text-slate-400 text-sm">No dietary options specified</p>
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {currentEntity.images?.length > 0 ? (
                      currentEntity.images.slice(0, 3).map((image, index) => (
                        <img
                          key={index}
                          src={image}
                          alt={`${currentEntity.name} image ${index + 1}`}
                          className="h-20 w-20 object-cover rounded-md"
                        />
                      ))
                    ) : (
                ...
                <div className="p-4 border rounded-lg border-slate-200">
                  ...
                  <div className="space-y-2">
                    {currentEntity.contactDetails?.phone && (
                      <div className="flex items-center">
                    ...
                    {currentEntity.contactDetails?.email && (
                      <div className="flex items-center">
                    ...
                    {currentEntity.contactDetails?.website && (
                      <div className="flex items-center">
                        <Globe className="h-4 w-4 mr-2 text-slate-400" />
                        <a
                          href={currentEntity.contactDetails.website}
                          target="_blank"
                ...
                {currentEntity.reviews?.length > 0 && (
                  <div className="p-4 border rounded-lg border-slate-200">
                    <h4 className="text-sm font-medium text-slate-700 mb-2">
                      Reviews ({currentEntity.reviews.length})
                    </h4>
                    <div className="space-y-3">
                      {currentEntity.reviews.slice(0, 2).map((review, index) => (
                      ...
                      {currentEntity.reviews.length > 2 && (
                        <p className="text-sm text-slate-500 mt-2">
                          + {currentEntity.reviews.length - 2} more reviews
                        </p>
                      )}
                    </div>
                  </div>
              ...
              <div className="flex items-center p-4 mb-4 bg-red-50 text-red-800 rounded-md">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-red-700">
                    Deleting{" "}
                    <span className="font-semibold">{currentEntity?.name}</span> will
                    remove all its data from your platform.
                  </p>
                </div>
              </div>
            </div>
